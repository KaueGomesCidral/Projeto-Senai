...
<head>
    ...
    <script src="venda_adicional.js" defer></script>
    ...
    <div class="body_adicional">
        ...
        <div class="cont_adicional">
            <div class="bloco_adicional">
                ...
                <form action=".dados_adicional.php" method="post" class="conteudo_adicional">
                    ...
                    <div class="inputVA">
                        ...
                        <div class="h">
                            ...
                            <textarea name="descricao" id="a" maxlength="150" cols="30" rows="5" placeholder="Faça uma Breve Descrição do seu Carro! Campo não Obrigatório."></textarea>

                            

                            <!-- <input type="text" name="descricao" class="input_descricao" id="descricao" maxlength="200" autocomplete="off" required> -->

const txt_vendidos = document.querySelector('.vendidos')
const txt_anunciados = document.querySelector('.anunciados')
const carros_vendidos = document.querySelector('.n')
const carros_anunciados = document.querySelector('.k')
...
txt_vendidos.addEventListener('click', () => {
    txt_vendidos.style.borderBottom = '2px solid #FF3C00'
    txt_anunciados.style.borderBottom = '0'
    carros_vendidos.style.display = 'block'
    carros_anunciados.style.display = 'none'
})

txt_anunciados.addEventListener('click', () => {
    txt_anunciados.style.borderBottom = '2px solid #FF3C00'
    txt_vendidos.style.borderBottom = '0'
    carros_anunciados.style.display = 'block'
    carros_vendidos.style.display = 'none'
})
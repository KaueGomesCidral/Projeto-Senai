    ...
    <div class="body_end">
        ...
        <div class="cont_end">
            <div class="bloco_end">
                ...
                <form action=".dados_endereco_carro.php" method="post" class="conteudo_end">
                    ...
                    <div class="botao">
                        ...
                        <!-- <input type="submit" name="continuar" value="Continuar" class="botao_end"> -->
                    </div>
...
<head>
    ...
    <link rel="shortcut icon" href="img/logotipo.png" type="image/x-icon">
    <link rel="stylesheet" href=".style_endereco.css">
    <script src="endereco_carro.js" defer></script>
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js" type="text/javascript"></script>
    <script src="https://igorescobar.github.io/jQuery-Mask-Plugin/js/jquery.mask.min.js"></script>
</head>

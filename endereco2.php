    ...
    <div class="body_end">
        ...
        <div class="cont_end">
            <div class="bloco_end">
                ...
                <form action=".dados_endereco.php" method="post" class="conteudo_end">
                    ...
                    <div class="botao">
                        <div class="botao_fake">Cadastrar</div>
                        <!-- <input type="submit" name="cadastrar" value="Cadastrar" class="botao_end"> -->
                    </div>

                    <div class="pular"><a class="j" href="index.php">Pular esta Etapa</a></div>
                    
                    <div class="i">Cep Inválido!</div>

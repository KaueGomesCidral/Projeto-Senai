const maior18 = document.querySelector('#maior18')
...
maior18.addEventListener('change', () => {
    if (maior18.checked == true && (tel.checked == true || email.checked == true)) {
        botao.innerHTML = '<input type="submit" name="finalizar" value="Finalizar" class="botao_confirma">'
    } else {
        botao.innerHTML = '<div class="botao_fake">Finalizar</div>'
    }
})
